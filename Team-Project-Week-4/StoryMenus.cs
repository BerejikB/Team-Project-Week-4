...
namespace Team_Project_Week_4
{
    class StoryMenus
    {
...

        {
            ...
            Console.ReadKey();
            Console.WriteLine("You decide to talk with uncle Jimmy.  ");
            Console.ReadKey();
            Console.WriteLine("You tell uncle Jimmy that you hate your job. ");
            Console.ReadKey();
        ...
        public void RecruiterDialogue()
        {
            ...
            Console.ReadKey();
            Console.WriteLine("");
            Console.WriteLine("1) Sign me up!");
            Console.WriteLine("2) Whats the catch?");
        ...
        public void SignMeUp()
        {
            ...
            Console.ReadKey();
            Console.WriteLine("*you sign the papers");
            Console.ReadKey();
            ThanksForOrgans();
        }
        ...
        public void WhatsTheCatch()
        {
            ...
            Console.WriteLine("None at all! Just read the terms and conditions and sign the papers!");
            Console.ReadKey();
            Console.WriteLine("1)Read the terms and condidions");
            Console.WriteLine("2)Sign the papers");
...
Your organs will be harvested at the age of 40.
...
");
            ...
            switch (userinputboi.Key)
            {
                ...
                case ConsoleKey.D2:
                    {
                        Console.WriteLine("You deny the terms and conditions and the AI disconnects");
                        Console.WriteLine("You go back to your previous job that you hate");
                        Console.Read();
                    }
                    break;
        ...
        public void NoToTerms()
        {
            Console.WriteLine("*you sign the papers");
            Console.ReadKey();
            ThanksForOrgans();
        }
        public void ThanksForOrgans()
        {
            Console.WriteLine("Wonderful. We will collect your organs in exactly 20 years. ");
            Console.ReadKey();
            Console.WriteLine("Wait what?!?!");
            Console.ReadKey();
            WTFmoment();
        }
        public void WTFmoment()
        {
            Console.WriteLine("(In the terms and conditions you failed to read, you allowed your organs to be collected at age 40)");
            Console.ReadKey();
            Console.WriteLine("Thank you for becoming a part of Space Shippers Inc!");
            Console.ReadKey();
            Console.WriteLine("*The AI disconnects");
            Console.ReadKey();
            WinConditon();
        }
        ...
        {
            Console.WriteLine("Shame you didn't read the terms and conditions!");
            Console.ReadKey();
            Console.WriteLine("You call your uncle Jimmy again.");
            Console.ReadKey();
            Console.WriteLine("Uncle Jimmy reckons, you have one of two ways out");
            Console.ReadKey();
            Console.WriteLine("You can either buy out your contract, or buy a new identity and escape to a resort planet.");
            Console.ReadKey();
            Console.WriteLine("If you wish to buy out your contract, you can return to Earth and purchase it. You will return to your previous job. ");
            Console.ReadKey();
            Console.WriteLine("If you wish to escape to a resort world, you must find the resort world, and purchase the *Escape From an Evil Company Package*");
            Console.ReadKey();
            Console.WriteLine("There's only one thing left to do now,");
            Console.ReadKey();
